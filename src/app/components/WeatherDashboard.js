  ...
  return (
    <div className="hidden mx-auto sm:block w-[92%] lg:w-[85%] max-w-[1320px] h-[668px] bg-[#6C6F75]/45 backdrop-blur-[8px] rounded-[25px]">
      <div className="w-full h-100 flex justify-between items-start px-8  xl:px-15 py-8">
        <div className="w-[45%] xl:w-[40%] h-full">
          ...
          <div className="w-full flex justify-between items-stretch h-[100px]">
            ...
            <div className="w-[30%] xl:w-[28%] aspect-[33/25] bg-[#BCC0C7]/50 backdrop-blur-[8px] rounded-[10px] p-3">
              <div className="flex flex-col gap-[10px] justify-center">
                <div className="flex justify-center items-center gap-1">
                  <img src="/icons/wind_white.svg" className="w-5 h-auto object-contain " alt="rainy" />
            ...
            <div className="w-[30%] xl:w-[28%] aspect-[33/25] bg-[#BCC0C7]/50 backdrop-blur-[8px] rounded-[10px] p-3">
              <div className="flex flex-col gap-[10px] justify-center">
                <div className="flex justify-center  items-center gap-1">
                  <img src="/icons/sun_white.svg" className="w-4 h-auto object-contain" alt="rainy" />
        ...
        <div className="w-[45%] lg:w-[38%] h-full flex-col justify-between">
          ...
          {weather?.daily?.slice(0, 7).map((item, id) => (
            <div key={id} className="flex justify-between items-center py-3 gap-[20px] border-b border-support4">
              <h2 className="w-20 text-primary">
              ...
              />
              <h2 className="w-[58px] text-primary text-center">
                {item.weather[0].main}
              </h2>
              <div className="w-9 flex justify-center items-center gap-[4px] text-primary text-center">
                <img src="/icons/up.svg" className="w-[6px] lg:w-[8px] auto object-contain" alt="arrow_up" />
                <h2>{Math.round(item.temp.max)}°</h2>
              </div>
              <div className="w-9 flex justify-center items-center gap-[4px] text-primary">
                <img src="/icons/down.svg" className="w-[8px] auto object-contain" alt="arrow_down" />
                <h2>{Math.round(item.temp.min)}°</h2>
              </div>
            </div>
          ))}
        </div>
